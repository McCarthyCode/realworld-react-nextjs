...
This codebase was created to demonstrate a fully fledged fullstack application built with **React/Next.js** including CRUD operations, authentication, routing, pagination, and more.

We've gone to great lengths to adhere to the **React/Next.js** community styleguides & best practices.
